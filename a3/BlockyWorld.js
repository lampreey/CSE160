...
function deleteCubesInView() {
    ...
    const length = Math.sqrt(viewDir[0]*viewDir[0] + viewDir[1]*viewDir[1] + viewDir[2]*viewDir[2]);
    const normViewDir = [
        viewDir[0]/length,
        viewDir[1]/length,
        viewDir[2]/length
    ...
    const cosFovAngle = Math.cos(fovAngle / 2);
    
    g_placedCubes = g_placedCubes.filter(cube => {
        ...
        const distToCube = Math.sqrt(toCube[0]*toCube[0] + toCube[1]*toCube[1] + toCube[2]*toCube[2]);
        ...
        const dotProduct = normViewDir[0]*normToCube[0] + 
                          normViewDir[1]*normToCube[1] + 
                          normViewDir[2]*normToCube[2];
        
        return !(dotProduct > cosFovAngle && distToCube < 5);
    });
...
function renderScene() {
    ...
    skyscraper1.position = [5, -0.75, -5];
    skyscraper1.size = [3, 10, 3];
    skyscraper1.render();

    var skyscraper2 = new Skyscraper()
    skyscraper2.position = [-5, -0.75, -4];
    skyscraper2.size = [3, 10, 3];
    skyscraper2.render();

    var skyscraper3 = new Skyscraper()
    skyscraper3.position = [-7, -0.75, 8];
    skyscraper3.size = [3, 10, 3];
    skyscraper3.render();

    var skyscraper4 = new Skyscraper()
    skyscraper4.position = [7, -0.75, 3];
    skyscraper4.size = [3, 10, 3];
    skyscraper4.render();

    var skyscraper5 = new Skyscraper()
    skyscraper5.position = [8, -0.75, 8];
    skyscraper5.size = [3, 10, 3];
    skyscraper5.render();
